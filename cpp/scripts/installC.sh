#!/bin/sh
#
# $Id: installC.sh 2896 2013-07-05 19:02:04Z gerhardus $
#
# Gerhardus Muller
...
execDir=/var/lib/lxc/$containerName/rootfs/usr/local/bin
etcDir=/var/lib/lxc/$containerName/rootfs/usr/local/etc
etc=/var/lib/lxc/$containerName/rootfs/etc
runAsUser=uucp
groupOwner=uucp
#confFile=
#runAsUser=gerhardus
